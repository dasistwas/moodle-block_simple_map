...
function specialization() {
		$this->title = isset($this->config->title) ? format_string($this->config->title) : format_string(get_string('pluginname', 'block_simple_map'));
		if($this->title == ''){
...
public function get_content() {
    ...
    if (! empty($this->config->googleAPIkey)) {
    	$googleAPIkey = $this->config->googleAPIkey;
	}
	else {
		$googleAPIkey = 'not yet specified';
	}
	...
	$data = '<script type="text/javascript" src="'. $CFG->wwwroot .'/blocks/simple_map/javascript/jquery.min.js"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=false" type="text/javascript"></script>
    <script type="text/javascript" src="'. $CFG->wwwroot .'/blocks/simple_map/javascript/gmap3.min.js"></script>
    <script type="text/javascript" src="'. $CFG->wwwroot .'/blocks/simple_map/javascript/jquery-autocomplete.min.js"></script>
    <script type="text/javascript" src="'. $CFG->wwwroot .'/blocks/simple_map/javascript/custom.js"></script>
   ...
   <div id="simplemapwwwroot" style="display: none;">'.$CFG->wwwroot.'</div>      
   <div id="s_map"> 
    <form action="">
